...
if(isset($_POST['edit_product'])){
    ...
    $product_images1 = $FILES['product_images1']['name'];
    $product_images2 = $FILES['product_images2']['name'];
    $product_images3 = $FILES['product_images3']['name'];

    $temp_images1 = $FILES['product_images1']['tmp_name'];
    $temp_images2 = $FILES['product_images2']['tmp_name'];
    $temp_images3 = $FILES['product_images3']['tmp_name'];

    // checking for fields empty or not
    if($product_title=='' or $product_description=='' or $product_keywords=='' or $product_category=='' or $product_brands='' or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price=='' or $first_release==''or $product_color==''or $network==''or $sim==''or $usb_type==''or $product_material==''or $product_dimension==''or $product_weight==''or $display_size==''or $display_resolution==''or 
    ...
    $operating_system==''or $chipset==''or $ram==''or $processor==''or $gpu==''or $rom==''or $micro_sd_slot==''or $sound_features==''or $made_in=='') {
        ...
        $update_product="update 'products' set product_title='$product_title', product_description='$product_desc', product_keywords='$product_keywords',  category_id='$product_category', brand_id='$product_brands', product_image1='$product_image1', product_image2='$product_image2', product_image3='$product_image3', product_price='$product_price', first_release='$first_release', product_color='$product_color', network='$network', sim='$sim', usb_type='$usb_type', product_material='$product_material', product_dimension='$product_dimension', product_weight='$product_weight', display_size='$display_size', display_resolution='$display_resolution', display_technology='$display_technology', display_features='$display_features', back_camera_resolution='$back_camera_resolution', back_camera_features='$back_camera_features', back_video_recording='$back_video_recording'front_camera_resolution='$front_camera_resolution'front_camera_features='$front_camera_features', front_video_recording='$front_video_recording', battery_capacity='$battery_capacity', charging_capacity='$charging_capacity', operating_system='$operating_system', chipset='$chipset', ram='$ram', processor='$processor', gpu='$gpu', rom='$rom', micro_sd_slot='$micro_sd_slot', sound_features='$sound_features', made_in='$made_in', date=NOW() where product_id=$edit_id ";
