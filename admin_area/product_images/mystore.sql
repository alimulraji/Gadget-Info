...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 14, 2024 at 09:12 AM
...
CREATE TABLE `product2` (
  ...
  `product_image2` varchar(222) NOT NULL,
  `product_image3` varchar(2222) NOT NULL,
  `product_price` varchar(100) NOT NULL,
  `date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `status` varchar(100) NOT NULL,
  `first_release` varchar(100) NOT NULL,
  ...
  `product_dimension` varchar(255) NOT NULL,
